...
- (IBAction)toggleGenerateToken:(id)sender {
    if ([self generateToken]) {
        ...
        [[((ELInspectorViewController *)[NSApp delegate])inspectorController] inspect:@"generate"];
    }
}
...
- (IBAction)toggleNoteToken:(id)sender {
    if ([self noteToken]) {
        ...
        [[((ELInspectorViewController *)[NSApp delegate])inspectorController] inspect:@"note"];
    }
}
...
- (IBAction)toggleReboundToken:(id)sender {
    if ([self reboundToken]) {
        ...
        [[((ELInspectorViewController *)[NSApp delegate])inspectorController] inspect:@"rebound"];
    }
}
...
- (IBAction)toggleAbsorbToken:(id)sender {
    if ([self absorbToken]) {
        ...
        [[((ELInspectorViewController *)[NSApp delegate])inspectorController] inspect:@"absorb"];
    }
}
...
- (IBAction)toggleSplitToken:(id)sender {
    if ([self splitToken]) {
        ...
        [[((ELInspectorViewController *)[NSApp delegate])inspectorController] inspect:@"split"];
    }
}
...
- (IBAction)toggleSpinToken:(id)sender {
    if ([self spinToken]) {
        ...
        [[((ELInspectorViewController *)[NSApp delegate])inspectorController] inspect:@"spin"];
    }
}
...
- (IBAction)toggleSkipToken:(id)sender {
    if ([self skipToken]) {
        ...
        [[((ELInspectorViewController *)[NSApp delegate])inspectorController] inspect:@"skip"];
    }
}
...
- (void)drawOnHoneycombView:(LMHoneycombView *)view withAttributes:(NSMutableDictionary *)attributes {
    if ([[self playheads] count] > 0) {
        ...
        if ([((ElysiumController *)[NSApp delegate])showKey]) {
            BOOL isTonic;
        ...
        else if ([((ElysiumController *)[NSApp delegate])showOctaves]) {
    ...
    if ([((ElysiumController *)[NSApp delegate])showNotes]) {
